...
class User {
  ...
  final _updatedFields = {};
  int? id;
  late String _firstName;
  String get firstName => _firstName;
  set firstName(String m) {
    _updatedFields['_firstName'] = m;
    _firstName = m;
  }
...
class Product {
  ...
  set sellingPrice(double m) {
    _updatedFields['_sellingPrice'] = m;
    _sellingPrice = m;
  }
