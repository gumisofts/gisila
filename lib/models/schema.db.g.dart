...
extension CatagoryDb on Catagory {
  ...
  static Future<void> save(Catagory catagory) async {}
...
extension BrandDb on Brand {
  ...
  static Future<void> save(Brand brand) async {}
...
extension AddressDb on Address {
  ...
  static Future<void> save(Address address) async {}
...
extension ShopDb on Shop {
  ...
  static Future<void> save(Shop shop) async {}
...
extension ShopAcitiviyDb on ShopAcitiviy {
  ...
  static Future<void> save(ShopAcitiviy shopacitiviy) async {}
...
extension ShopReviewDb on ShopReview {
  ...
  static Future<void> save(ShopReview shopreview) async {}
...
extension LikeDb on Like {
  ...
  static Future<void> save(Like like) async {}
...
extension FollowDb on Follow {
  ...
  static Future<void> save(Follow follow) async {}
...
extension ItemsDb on Items {
  ...
  static Future<void> save(Items items) async {}
...
extension GiftCardDb on GiftCard {
  ...
  static Future<void> save(GiftCard giftcard) async {}
...
extension BlockedDb on Blocked {
  ...
  static Future<void> save(Blocked blocked) async {}
...
extension PolicyDb on Policy {
  ...
  static Future<void> save(Policy policy) async {}
...
extension ReportDb on Report {
  ...
  static Future<void> save(Report report) async {}
